    ...
    var body: some View {
        ...
        ZStack {
            ...
            .frame(
                width:
                    pageWidth * 2
                    + bookBackgroundHorizontalPadding,

                height:
                    pageHeight
                    + bookBackgroundVerticalPadding
            )
...
private func isOuterCoverIndex(
    _ index: Int?,
    backCoverLeftIndex: Int
) -> Bool {
...
private struct BookTurningPage: View {
    ...
    private var frameSize: CGSize {
        ...
        let frontIsCover = isOuterCoverIndex(
            frontIndex,
            backCoverLeftIndex: backCoverLeftIndex
        )

        let backIsCover = isOuterCoverIndex(
            backIndex,
            backCoverLeftIndex: backCoverLeftIndex
        )
